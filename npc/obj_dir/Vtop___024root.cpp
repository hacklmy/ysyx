...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__1(Vtop___024root* vlSelf) {
    ...
    vlSelf->__Vdly__top__DOT__IDU__DOT__ds_valid = vlSelf->top__DOT__IDU__DOT__ds_valid;
    ...
    } else if (((IData)(vlSelf->top__DOT__IDU_io_br_taken) 
                & (~ (IData)(vlSelf->top__DOT__IFU__DOT__br_taken_cancel)))) {
        vlSelf->top__DOT__IFU__DOT__fs_valid = 0U;
    ...
    if (vlSelf->reset) {
    ...
    } else if ((((((0x6fU == (0x7fU & vlSelf->top__DOT__IDU__DOT__inst)) 
        ...
        vlSelf->__Vdly__top__DOT__IDU__DOT__ds_valid 
            = vlSelf->top__DOT__IFU_io_fs_to_ds_valid;
    }
    if (vlSelf->reset) {
