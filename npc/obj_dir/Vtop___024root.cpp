...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__1(Vtop___024root* vlSelf) {
    ...
    vlSelf->__Vdly__top__DOT__IFU__DOT__fs_valid = vlSelf->top__DOT__IFU__DOT__fs_valid;
    ...
    if (vlSelf->reset) {
        vlSelf->__Vdly__top__DOT__IFU__DOT__fs_valid = 0U;
    } else if (((IData)(vlSelf->top__DOT__IFU__DOT__br_taken) 
                | (IData)(vlSelf->top__DOT__IDU_io_br_taken))) {
        vlSelf->__Vdly__top__DOT__IFU__DOT__fs_valid = 0U;
    } else if (vlSelf->top__DOT__IFU__DOT__fs_allowin) {
        vlSelf->__Vdly__top__DOT__IFU__DOT__fs_valid 
            = vlSelf->top__DOT__i_cache_io_to_ifu_rvalid;
    }
    if (vlSelf->reset) {
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->__Vdly__top__DOT__IDU__DOT__ds_valid 
            = vlSelf->top__DOT__IFU__DOT__fs_valid;
    }
    if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->reset))))) {
        VL_FWRITEF(0x80000002U,"ds_pc:%x ds_valid:%1# ds_allowin:%1# ds_ready_go:%1# inst:%x br_taken:%1# src1:%x src2:%x conflict_es_rs1:%1# conflict_es_rs2:%1# conflict_ms1:%1# conflict_ms2:%1#\n",
                   ...
                   64,vlSelf->top__DOT__IDU_io_src2,
