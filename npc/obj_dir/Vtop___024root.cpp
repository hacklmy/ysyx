...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__2(Vtop___024root* vlSelf) {
    ...
    // Variables
    CData/*2:0*/ __Vdly__top__DOT__ifu_step__DOT__axi__DOT__state;
    CData/*4:0*/ __Vdlyvdim0__top__DOT__exu_step__DOT__Regfile__v0;
    CData/*1:0*/ __Vdlyvdim0__top__DOT__exu_step__DOT__CSR_Reg__v2;
    CData/*0:0*/ __Vdly__top__DOT__exu_step__DOT__axi_bready;
    CData/*0:0*/ __Vdly__top__DOT__exu_step__DOT__axi_awvalid;
    CData/*2:0*/ __Vdly__top__DOT__exu_step__DOT__axi__DOT__state;
    ...
    // Body
    __Vdly__top__DOT__exu_step__DOT__axi__DOT__state 
    ...
    __Vdly__top__DOT__exu_step__DOT__axi_awvalid = vlSelf->top__DOT__exu_step__DOT__axi_awvalid;
    if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->reset))))) {
        VL_FWRITEF(0x80000002U,"pc_valid : %1#\n",1,
                   vlSelf->top__DOT__ifu_step_io_pc_valid);
    }
    __Vdly__top__DOT__ifu_step__DOT__axi__DOT__state 
        = vlSelf->top__DOT__ifu_step__DOT__axi__DOT__state;
    if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->reset))))) {
        VL_FWRITEF(0x80000002U,"Writemem_en:%1# Readmem_en:%1#\n",
                   1,(0x44U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_type_T_188)),
                   1,((0x3003U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                      | ((0x2003U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                         | ((0x6003U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                            | ((0x1003U == (0x707fU 
    ...
    if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->reset))))) {
        VL_FWRITEF(0x80000002U,"pc : %x inst_now : %x  valid: %1#\n",
                   64,vlSelf->top__DOT__pc_now,32,(IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194),
                   1,vlSelf->top__DOT__exu_step_io_inst_valid);
    }
    if (VL_UNLIKELY((1U & (~ (IData)(vlSelf->reset))))) {
    ...
    vlSelf->top__DOT__npc_step = ((~ (IData)(vlSelf->reset)) 
                                  & (((IData)(vlSelf->top__DOT__exu_step_io_inst_valid) 
                                     ...
                                     | ((IData)(vlSelf->top__DOT__exu_step_io_mem_flag) 
                                        & (IData)(vlSelf->top__DOT__exu_step_io_mem_end))));
    vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_wready 
        = ((IData)(vlSelf->reset) | (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT___GEN_27));
    vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_arready 
        = ((IData)(vlSelf->reset) | (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT___GEN_29));
    __Vdly__top__DOT__exu_step__DOT__axi_bready = (1U 
                                                   & ((IData)(vlSelf->reset) 
                                                      | (~ 
                                                         ((IData)(vlSelf->top__DOT__exu_step__DOT__axi_bready) 
                                                          & (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_bvalid)))));
    vlSelf->top__DOT__exu_step__DOT__axi_rready = (1U 
                                                   & ((IData)(vlSelf->reset) 
                                                      | (~ 
    ...
    __Vdly__top__DOT__exu_step__DOT__axi_awvalid = 
        ((~ (IData)(vlSelf->reset)) & (((0x44U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_type_T_188)) 
                                        & (IData)(vlSelf->top__DOT__exu_step_io_inst_valid)) 
                                       & (~ (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_bvalid))));
    ...
    __Vdlyvdim0__top__DOT__exu_step__DOT__Regfile__v0 
        = (0x1fU & (IData)((vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata 
                            >> 7U)));
    vlSelf->top__DOT__ifu_step__DOT__axi__DOT__axi_arready 
        = ((IData)(vlSelf->reset) | (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT___GEN_29));
    ...
    } else if ((((IData)(vlSelf->top__DOT__exu_step_io_inst_valid) 
                 & (~ (IData)(vlSelf->top__DOT__exu_step_io_mem_flag))) 
                | ((IData)(vlSelf->top__DOT__exu_step_io_mem_flag) 
                   & (IData)(vlSelf->top__DOT__exu_step_io_mem_end)))) {
    ...
    if (vlSelf->reset) {
        vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_bvalid = 0U;
    } else if ((0U == (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__state))) {
        vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_bvalid 
            = vlSelf->top__DOT__exu_step__DOT__axi__DOT___GEN_6;
    } else if ((3U == (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__state))) {
        if (vlSelf->top__DOT__exu_step__DOT__axi_bready) {
            vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_bvalid = 0U;
        }
    }
    if (vlSelf->reset) {
        vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_rvalid = 0U;
    } else if ((0U == (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__state))) {
        if ((1U & (~ (IData)(vlSelf->top__DOT__exu_step__DOT__axi_awvalid)))) {
            vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_rvalid 
                = vlSelf->top__DOT__exu_step__DOT__axi__DOT___GEN_2;
        }
    } else if ((3U != (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__state))) {
        if ((4U == (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__state))) {
            vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_rvalid 
                = vlSelf->top__DOT__exu_step__DOT__axi__DOT___GEN_15;
        }
    }
    if (vlSelf->reset) {
        __Vdly__top__DOT__exu_step__DOT__axi__DOT__state = 0U;
    } else if ((0U == (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__state))) {
        if (vlSelf->top__DOT__exu_step__DOT__axi_awvalid) {
            __Vdly__top__DOT__exu_step__DOT__axi__DOT__state = 3U;
        } else if (vlSelf->top__DOT__exu_step__DOT__axi_arvalid) {
            __Vdly__top__DOT__exu_step__DOT__axi__DOT__state = 4U;
        }
    } else if ((3U == (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__state))) {
        if (vlSelf->top__DOT__exu_step__DOT__axi_bready) {
            __Vdly__top__DOT__exu_step__DOT__axi__DOT__state = 0U;
        }
    } else if ((4U == (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__state))) {
        __Vdly__top__DOT__exu_step__DOT__axi__DOT__state 
            = vlSelf->top__DOT__exu_step__DOT__axi__DOT___GEN_13;
    }
    ...
    if (vlSelf->reset) {
        vlSelf->top__DOT__ifu_step__DOT__axi__DOT__axi_bvalid = 0U;
    } else if ((0U == (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__state))) {
    ...
    } else if ((3U != (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__state))) {
        if ((4U == (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__state))) {
            vlSelf->top__DOT__ifu_step__DOT__axi__DOT__axi_rvalid 
                = vlSelf->top__DOT__ifu_step__DOT__axi__DOT___GEN_15;
        }
    }
    if (vlSelf->reset) {
        __Vdly__top__DOT__ifu_step__DOT__axi__DOT__state = 0U;
    } else if ((0U == (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__state))) {
        if (vlSelf->top__DOT__ifu_step_io_pc_valid) {
            __Vdly__top__DOT__ifu_step__DOT__axi__DOT__state = 4U;
        }
    } else if ((3U != (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__state))) {
        if ((4U == (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__state))) {
            __Vdly__top__DOT__ifu_step__DOT__axi__DOT__state 
    ...
    vlSelf->top__DOT__exu_step__DOT__axi_bready = __Vdly__top__DOT__exu_step__DOT__axi_bready;
    vlSelf->top__DOT__exu_step__DOT__axi__DOT__state 
        = __Vdly__top__DOT__exu_step__DOT__axi__DOT__state;
    vlSelf->top__DOT__exu_step__DOT__axi_awvalid = __Vdly__top__DOT__exu_step__DOT__axi_awvalid;
    vlSelf->top__DOT__ifu_step__DOT__axi__DOT__state 
        = __Vdly__top__DOT__ifu_step__DOT__axi__DOT__state;
    ...
    vlSelf->top__DOT__exu_step__DOT__axi__DOT___GEN_13 
        = ((IData)(vlSelf->top__DOT__exu_step__DOT__axi_rready)
            ? 0U : (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__state));
    vlSelf->top__DOT__exu_step__DOT__axi__DOT___GEN_6 
        = ((IData)(vlSelf->top__DOT__exu_step__DOT__axi_awvalid) 
           | (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_bvalid));
    vlSelf->top__DOT__exu_step__DOT__axi__DOT___GEN_27 
        = ((0U == (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__state))
            ? ((~ (IData)(vlSelf->top__DOT__exu_step__DOT__axi_awvalid)) 
               & (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_wready))
            : ((3U == (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__state))
                ? ((IData)(vlSelf->top__DOT__exu_step__DOT__axi_bready) 
                   | (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_wready))
                : (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_wready)));
    vlSelf->top__DOT__exu_step__DOT__axi_arvalid = 
        ((~ (IData)(vlSelf->reset)) & ((IData)(vlSelf->top__DOT__exu_step_io_inst_valid) 
    ...
    vlSelf->top__DOT__exu_step_io_inst_valid = ((IData)(vlSelf->top__DOT__idu_step__DOT__axi_inst_ready) 
                                                & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__axi_rvalid));
    vlSelf->top__DOT__exu_step__DOT__axi__DOT___GEN_2 
        = ((IData)(vlSelf->top__DOT__exu_step__DOT__axi_arvalid) 
           | (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_rvalid));
    vlSelf->top__DOT__exu_step__DOT__axi__DOT___GEN_29 
        = ((0U == (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__state))
            ? ((IData)(vlSelf->top__DOT__exu_step__DOT__axi_awvalid)
            ...
            : ((3U == (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__state))
                ? (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_arready)
                : ((4U == (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__state))
                    ? ((IData)(vlSelf->top__DOT__exu_step__DOT__axi_rready) 
                       | (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_arready))
                    : (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_arready))));
}
...
VL_INLINE_OPT void Vtop___024root___combo__TOP__3(Vtop___024root* vlSelf) {
    ...
    // Body
    vlSelf->top__DOT__ifu_step_io_pc_valid = (1U & 
                                              ((0x80000000ULL 
    ...
    vlSelf->top__DOT__ifu_step__DOT__axi__DOT___GEN_2 
        = ((IData)(vlSelf->top__DOT__ifu_step_io_pc_valid) 
           | (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__axi_rvalid));
    vlSelf->top__DOT__ifu_step__DOT__axi__DOT___GEN_29 
        = ((0U == (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__state))
            ? ((~ (IData)(vlSelf->top__DOT__ifu_step_io_pc_valid)) 
               & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__axi_arready))
            : ((3U == (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__state))
                ? (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__axi_arready)
                : ((4U == (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__state))
                    ? ((IData)(vlSelf->top__DOT__idu_step__DOT__axi_inst_ready) 
                       | (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__axi_arready))
                    : (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__axi_arready))));
    ...
    vlSelf->io_inst = (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata);
    vlSelf->top__DOT__idu_step__DOT___reg_write_T_37 
        = ((0x3023U != (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
           & ((0x1023U != (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
              & ((0x23U != (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                 & ((0x2023U != (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                    & ((0x1063U != (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                       & ((0x63U != (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                          & ((0x5063U != (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                             & ((0x4063U != (0x707fU 
                                             & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                                & ((0x6063U != (0x707fU 
                                                & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                                   & ((0x7063U != (0x707fU 
                                                   & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                                      & ((0x73U != (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata)) 
                                         & (0x30200073U 
                                            != (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata)))))))))))));
    vlSelf->top__DOT__idu_step_io_ctrl_sign_Readmem_en 
        = ((0x3003U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
           | ((0x2003U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
              | ((0x6003U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                 | ((0x1003U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                    | ((0x5003U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                       | ((3U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                          | (0x4003U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata)))))))));
    ...
    vlSelf->top__DOT__idu_step_io_ctrl_sign_src1_is_pc 
        = ((0x6fU == (0x7fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
           | ((0x17U == (0x7fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
              | ((0x1063U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                 | ((0x63U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                    | ((0x5063U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                       | ((0x4063U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                          | ((0x6063U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                             | (0x7063U == (0x707fU 
                                            & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))))))))));
    ...
    if ((0x13U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata)))) {
        ...
        vlSelf->top__DOT__idu_step__DOT___inst_now_T_194 
            = ((0x100073U == (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))
                ? 2U : ((0x17U == (0x7fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata)))
                         ? 3U : ((0x37U == (0x7fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata)))
                                  ? 4U : ((0x6fU == 
                                           (0x7fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata)))
                                           ? 5U : (
                                                   (0x67U 
                                                    == 
                                                    (0x707fU 
        ...
        vlSelf->top__DOT__idu_step__DOT___inst_type_T_188 
            = ((0x17U == (0x7fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata)))
                ? 0x42U : ((0x37U == (0x7fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata)))
                            ? 0x42U : ((0x6fU == (0x7fU 
                                                  & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata)))
                                        ? 0x43U : (
                                                   (0x67U 
    ...
    Vtop___024unit____Vdpiimwrap_ecall_handle_TOP____024unit(
                                                             (0x3dU 
                                                              == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194)));
    vlSelf->top__DOT__exu_step__DOT___T_7 = ((0x3dU 
                                              == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194)) 
                                             & (IData)(vlSelf->top__DOT__exu_step_io_inst_valid));
    vlSelf->top__DOT__exu_step_io_mem_flag = ((IData)(vlSelf->top__DOT__idu_step_io_ctrl_sign_Readmem_en) 
                                              | (0x44U 
                                                 == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_type_T_188)));
    vlSelf->top__DOT__exu_step_io_mem_end = ((((IData)(vlSelf->top__DOT__idu_step_io_ctrl_sign_Readmem_en) 
                                               & (IData)(vlSelf->top__DOT__exu_step__DOT__axi_rready)) 
                                              & (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_rvalid)) 
                                             | (((0x44U 
                                                  == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_type_T_188)) 
                                                    ...
                                                    | (QData)((IData)(
                                                                      (0xfffU 
                                                                       & (IData)(
                                                                                ...
                                                                                >> 0x14U))))))
                                                    : 0ULL)))));
    if (vlSelf->top__DOT__exu_step__DOT___T_7) {
        vlSelf->top__DOT__exu_step__DOT__CSR_Reg_MPORT_1_data 
            = vlSelf->top__DOT__pc_now;
        vlSelf->top__DOT__exu_step__DOT__CSR_Reg_MPORT_3_data 
            = vlSelf->top__DOT__exu_step__DOT__Regfile
    ...
    vlSelf->top__DOT__exu_step__DOT__CSR_Reg_MPORT_6_data 
        = ((((0x1073U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
             | ((0x2073U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))) 
                | (0x3073U == (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata))))) 
            & (IData)(vlSelf->top__DOT__exu_step_io_inst_valid))
    ...
    vlSelf->top__DOT__exu_step__DOT__srl_res = (vlSelf->top__DOT__exu_step__DOT__src1_value 
                                                ...
                                                (0x3fU 
                                                 & (IData)(vlSelf->top__DOT__exu_step__DOT__src2_value)));
    VL_EXTEND_WQ(127,64, __Vtemp88, vlSelf->top__DOT__exu_step__DOT__src1_value);
    ...
    if (((IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__axi_wready) 
         & (IData)(vlSelf->top__DOT__exu_step__DOT__axi_awvalid))) {
        Vtop___024unit____Vdpiimwrap_pmem_write_TOP____024unit((QData)((IData)(vlSelf->top__DOT__exu_step__DOT__add_res)), (QData)((IData)(
                                                                                ((0x27U 
                                                                                == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                                                                 ? (QData)((IData)(
                                                                                ((0U 
    ...
    top__DOT__exu_step__DOT___io_res2rd_T_132 = ((0x24U 
                                                 ...
                                                 ((((1U 
                                                  ...
                                                  | (QData)((IData)(
                                                                    (0xffffU 
                                                                     & (IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__Mem_modle_Rdata)))))
                                                  : 
                                                 ((0x3aU 
                                                   == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                                   ? (QData)((IData)(vlSelf->top__DOT__exu_step__DOT__axi__DOT__Mem_modle_Rdata))
                                                   : 
                                                  ((0x23U 
                                                    == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                                    ? (QData)((IData)(
    ...
    VL_EXTENDS_WQ(65,64, __Vtemp93, vlSelf->top__DOT__exu_step__DOT__src1_value);
    __Vtemp94[0U] = __Vtemp93[0U];
    __Vtemp94[1U] = __Vtemp93[1U];
    __Vtemp94[2U] = (1U & __Vtemp93[2U]);
    VL_EXTENDS_WQ(65,64, __Vtemp96, vlSelf->top__DOT__exu_step__DOT__src2_value);
    __Vtemp97[0U] = __Vtemp96[0U];
    __Vtemp97[1U] = __Vtemp96[1U];
    __Vtemp97[2U] = (1U & __Vtemp96[2U]);
    VL_DIVS_WWW(65, __Vtemp98, __Vtemp94, __Vtemp97);
    __Vtemp99[0U] = __Vtemp98[0U];
    __Vtemp99[1U] = __Vtemp98[1U];
    __Vtemp99[2U] = (1U & __Vtemp98[2U]);
    VL_EXTEND_WW(127,65, __Vtemp100, __Vtemp99);
    VL_EXTEND_WQ(127,64, __Vtemp101, VL_DIV_QQQ(64, vlSelf->top__DOT__exu_step__DOT__src1_value, vlSelf->top__DOT__exu_step__DOT__src2_value));
    VL_EXTEND_WQ(127,64, __Vtemp102, (((QData)((IData)(
                                                       ((1U 
                                                         & (IData)(
                                                                   (vlSelf->top__DOT__exu_step__DOT___divw_res_T_4 
                                                                    >> 0x1fU)))
    ...
    VL_EXTEND_WQ(127,64, __Vtemp103, (((QData)((IData)(
                                                       ((1U 
                                                         & (IData)(
                                                                   (vlSelf->top__DOT__exu_step__DOT___mluw_res_T_2 
                                                                    >> 0x1fU)))
    ...
    VL_EXTEND_WQ(128,64, __Vtemp104, vlSelf->top__DOT__exu_step__DOT__src1_value);
    VL_EXTEND_WQ(128,64, __Vtemp105, vlSelf->top__DOT__exu_step__DOT__src2_value);
    VL_MUL_W(4, __Vtemp106, __Vtemp104, __Vtemp105);
    VL_EXTEND_WQ(127,64, __Vtemp107, (((QData)((IData)(
                                                       __Vtemp106[1U])) 
                                       << 0x20U) | (QData)((IData)(
                                                                   __Vtemp106[0U]))));
    ...
    VL_EXTEND_WQ(127,64, __Vtemp110, top__DOT__exu_step__DOT___io_res2rd_T_74);
    VL_EXTEND_WQ(127,64, __Vtemp111, top__DOT__exu_step__DOT___io_res2rd_T_69);
    VL_EXTEND_WQ(127,64, __Vtemp112, top__DOT__exu_step__DOT___io_res2rd_T_59);
    VL_EXTEND_WQ(127,64, __Vtemp113, vlSelf->top__DOT__exu_step__DOT__srl_res);
    VL_EXTEND_WQ(127,64, __Vtemp114, top__DOT__exu_step__DOT___io_res2rd_T_162);
    if ((0x31U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))) {
        ...
        top__DOT__exu_step__DOT___io_res2rd_T_186[0U] 
            = ((0x30U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                ? __Vtemp101[0U] : ((0x13U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                     ? __Vtemp102[0U]
        ...
        top__DOT__exu_step__DOT___io_res2rd_T_186[1U] 
            = ((0x30U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                ? __Vtemp101[1U] : ((0x13U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                     ? __Vtemp102[1U]
                                     : ((0x12U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                         ? __Vtemp103[1U]
                                         : ((0x11U 
        ...
        top__DOT__exu_step__DOT___io_res2rd_T_186[2U] 
            = ((0x30U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                ? __Vtemp101[2U] : ((0x13U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                     ? __Vtemp102[2U]
                                     : ((0x12U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                         ? __Vtemp103[2U]
                                         : ((0x11U 
        ...
        top__DOT__exu_step__DOT___io_res2rd_T_186[3U] 
            = ((0x30U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                ? __Vtemp101[3U] : ((0x13U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                     ? __Vtemp102[3U]
                                     : ((0x12U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                         ? __Vtemp103[3U]
                                         : ((0x11U 
    ...
    VL_EXTEND_WQ(127,64, __Vtemp139, vlSelf->top__DOT__exu_step__DOT__CSR_Reg
                 [((0x342U == (0xfffU & (IData)(vlSelf->top__DOT__idu_step_io_imm)))
                    ? 3U : (IData)(vlSelf->top__DOT__exu_step__DOT___csr_index_T_5))]);
    VL_EXTEND_WQ(127,64, __Vtemp140, vlSelf->top__DOT__exu_step__DOT__CSR_Reg
                 [((0x342U == (0xfffU & (IData)(vlSelf->top__DOT__idu_step_io_imm)))
                    ? 3U : (IData)(vlSelf->top__DOT__exu_step__DOT___csr_index_T_5))]);
    VL_EXTEND_WQ(127,64, __Vtemp141, vlSelf->top__DOT__exu_step__DOT__CSR_Reg
                 [((0x342U == (0xfffU & (IData)(vlSelf->top__DOT__idu_step_io_imm)))
                    ? 3U : (IData)(vlSelf->top__DOT__exu_step__DOT___csr_index_T_5))]);
    VL_EXTEND_WQ(127,64, __Vtemp142, vlSelf->top__DOT__exu_step__DOT__srl_res);
    VL_EXTEND_WQ(127,64, __Vtemp143, vlSelf->top__DOT__exu_step__DOT__sra_res);
    VL_EXTEND_WQ(127,64, __Vtemp144, VL_MODDIVS_QQQ(64, vlSelf->top__DOT__exu_step__DOT__src1_value, vlSelf->top__DOT__exu_step__DOT__src2_value));
    VL_EXTEND_WQ(127,64, __Vtemp145, VL_MODDIV_QQQ(64, vlSelf->top__DOT__exu_step__DOT__src1_value, vlSelf->top__DOT__exu_step__DOT__src2_value));
    ...
    if ((0x47U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))) {
        ...
        vlSelf->top__DOT__exu_step__DOT___io_res2rd_T_208[0U] 
            = ((0x46U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                ? __Vtemp140[0U] : ((0x3fU == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                     ? __Vtemp141[0U]
        ...
        vlSelf->top__DOT__exu_step__DOT___io_res2rd_T_208[1U] 
            = ((0x46U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                ? __Vtemp140[1U] : ((0x3fU == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                     ? __Vtemp141[1U]
                                     : ((0x38U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                         ? __Vtemp142[1U]
                                         : ((0x39U 
        ...
        vlSelf->top__DOT__exu_step__DOT___io_res2rd_T_208[2U] 
            = ((0x46U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                ? __Vtemp140[2U] : ((0x3fU == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                     ? __Vtemp141[2U]
                                     : ((0x38U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                         ? __Vtemp142[2U]
                                         : ((0x39U 
        ...
        vlSelf->top__DOT__exu_step__DOT___io_res2rd_T_208[3U] 
            = ((0x46U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                ? __Vtemp140[3U] : ((0x3fU == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                     ? __Vtemp141[3U]
                                     : ((0x38U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                         ? __Vtemp142[3U]
                                         : ((0x39U 
    ...
    vlSelf->top__DOT__exu_step__DOT__Regfile_MPORT_data 
        = (((((0x100073U != (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata)) 
             ...
             & (0U != (0x1fU & (IData)((vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata 
                                        >> 7U))))) 
            & (IData)(vlSelf->top__DOT__exu_step_io_inst_valid))
...
VL_INLINE_OPT QData Vtop___024root___change_request_1(Vtop___024root* vlSelf) {
    ...
    __req |= ((vlSelf->top__DOT__exu_step_io_mem_end ^ vlSelf->__Vchglast__TOP__top__DOT__exu_step_io_mem_end));
    VL_DEBUG_IF( if(__req && ((vlSelf->top__DOT__exu_step_io_mem_end ^ vlSelf->__Vchglast__TOP__top__DOT__exu_step_io_mem_end))) VL_DBG_MSGF("        CHANGE: vsrc/top.v:56: top.exu_step_io_mem_end\n"); );
    // Final
    vlSelf->__Vchglast__TOP__top__DOT__exu_step_io_mem_end 
        = vlSelf->top__DOT__exu_step_io_mem_end;
    return __req;
}
