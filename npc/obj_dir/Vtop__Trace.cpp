...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
            ...
            tracep->chgIData(oldp+286,(vlSelf->top__DOT__EXU__DOT__inst_now),32);
            tracep->chgQData(oldp+287,(vlSelf->top__DOT__EXU__DOT__add_res),64);
            tracep->chgQData(oldp+289,(vlSelf->top__DOT__EXU__DOT__sub_res),64);
            tracep->chgQData(oldp+291,(vlSelf->top__DOT__EXU__DOT__sra_res),64);
            tracep->chgQData(oldp+293,(vlSelf->top__DOT__EXU__DOT__srl_res),64);
            tracep->chgWData(oldp+295,(vlSelf->top__DOT__EXU__DOT__sll_res),127);
            ...
            tracep->chgIData(oldp+300,(vlSelf->top__DOT__EXU__DOT__srlw_res),32);
            tracep->chgQData(oldp+301,(vlSelf->top__DOT__EXU__DOT__sllw_res),63);
            tracep->chgQData(oldp+303,(vlSelf->top__DOT__EXU__DOT__or_res),64);
            tracep->chgQData(oldp+305,(vlSelf->top__DOT__EXU__DOT__xor_res),64);
            tracep->chgQData(oldp+307,(vlSelf->top__DOT__EXU__DOT__and_res),64);
            ...
            tracep->chgQData(oldp+309,((((QData)((IData)(
                                        ...
                                        | (QData)((IData)(
                                                          __Vtemp241[0U])))),64);
            tracep->chgIData(oldp+311,((IData)(vlSelf->top__DOT__EXU__DOT___mluw_res_T_2)),32);
            tracep->chgIData(oldp+312,((IData)(vlSelf->top__DOT__EXU__DOT___divw_res_T_4)),32);
            tracep->chgIData(oldp+313,(vlSelf->top__DOT__EXU__DOT__divuw_res),32);
            tracep->chgIData(oldp+314,(vlSelf->top__DOT__EXU__DOT__remw_res),32);
            tracep->chgIData(oldp+315,(vlSelf->top__DOT__EXU__DOT__remuw_res),32);
            ...
            tracep->chgWData(oldp+316,(__Vtemp250),65);
            ...
            tracep->chgQData(oldp+325,(vlSelf->top__DOT__LSU__DOT__maddr),64);
            tracep->chgQData(oldp+327,(vlSelf->top__DOT__LSU__DOT__Mem_modle_Rdata),64);
            tracep->chgQData(oldp+329,(vlSelf->top__DOT__LSU__DOT__store_data),64);
            tracep->chgCData(oldp+331,(vlSelf->top__DOT__LSU__DOT__wstrb),8);
            tracep->chgBit(oldp+332,(vlSelf->top__DOT__LSU__DOT__wen));
            tracep->chgBit(oldp+333,(vlSelf->top__DOT__LSU__DOT__ren));
            tracep->chgQData(oldp+334,(vlSelf->top__DOT__LSU__DOT__ms_res),64);
        }
        tracep->chgBit(oldp+336,(vlSelf->clock));
        tracep->chgBit(oldp+337,(vlSelf->reset));
        tracep->chgIData(oldp+338,(vlSelf->io_inst),32);
        tracep->chgQData(oldp+339,(vlSelf->io_pc),64);
        tracep->chgBit(oldp+341,(vlSelf->io_step));
    }
}
