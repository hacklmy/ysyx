...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
            ...
            tracep->chgQData(oldp+76,((0xfffffffffffffffeULL 
                                       & vlSelf->top__DOT__exu_step__DOT__add_res)),64);
        }
        tracep->chgBit(oldp+78,(vlSelf->clock));
        tracep->chgBit(oldp+79,(vlSelf->reset));
        tracep->chgIData(oldp+80,(vlSelf->io_inst),32);
        tracep->chgQData(oldp+81,(vlSelf->io_pc),64);
        tracep->chgQData(oldp+83,(vlSelf->io_outval),64);
        tracep->chgCData(oldp+85,((0x1fU & (vlSelf->io_inst 
                                            >> 0xfU))),5);
        tracep->chgCData(oldp+86,((0x1fU & (vlSelf->io_inst 
                                            >> 0x14U))),5);
        tracep->chgCData(oldp+87,((0x1fU & (vlSelf->io_inst 
                                            >> 7U))),5);
        tracep->chgBit(oldp+88,(((0x100073U != vlSelf->io_inst) 
                                 & (0x3023U != (0x707fU 
                                                & vlSelf->io_inst)))));
        tracep->chgBit(oldp+89,((0x6fU == (0x7fU & vlSelf->io_inst))));
        tracep->chgQData(oldp+90,(((6U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_20))
                                    ? vlSelf->top__DOT__exu_step__DOT__add_res
                                    : ((5U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_20))
                                        ? vlSelf->top__DOT__exu_step__DOT__add_res
                                        : (4ULL + vlSelf->top__DOT__pc_now)))),64);
        tracep->chgSData(oldp+92,((vlSelf->io_inst 
                                   >> 0x14U)),12);
        tracep->chgIData(oldp+93,(((0x80000U & (vlSelf->io_inst 
                                                >> 0xcU)) 
                                   | ((0x7f800U & (vlSelf->io_inst 
                                      ...
                                      | ((0x400U & 
                                         ...
                                         | (0x3ffU 
                                            & (vlSelf->io_inst 
                                               >> 0x15U)))))),20);
        tracep->chgIData(oldp+94,((vlSelf->io_inst 
                                   >> 0xcU)),20);
        tracep->chgSData(oldp+95,(((0xfe0U & (vlSelf->io_inst 
                                              >> 0x14U)) 
        ...
        tracep->chgQData(oldp+100,(vlSelf->top__DOT__exu_step__DOT__Regfile
                                   [(0x1fU & (vlSelf->io_inst 
                                              >> 7U))]),64);
        tracep->chgQData(oldp+102,((((0x100073U != vlSelf->io_inst) 
                                     & (0x3023U != 
                                     ...
                                     : ((0U == (0x1fU 
                                        ...
                                        [(0x1fU & (vlSelf->io_inst 
                                                   >> 7U))]))),64);
        tracep->chgQData(oldp+104,(((0x6fU == (0x7fU 
                                               & vlSelf->io_inst))
                                     ...
                                     : ((0U == (0x1fU 
                                        ...
                                        [(0x1fU & (vlSelf->io_inst 
                                                   >> 0xfU))]))),64);
        tracep->chgQData(oldp+106,((((0x43U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_type_T_17)) 
                                     | ((0x44U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_type_T_17)) 
                                        | ((0x42U == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_type_T_17)) 
                                           | (0x40U 
                                              == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_type_T_17)))))
