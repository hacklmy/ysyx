...
void Vtop___024root__traceChgSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
            ...
            tracep->chgBit(oldp+34,(((IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__axi_arready) 
            ...
            tracep->chgQData(oldp+199,(((0x3dU == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                        ...
                                        [1U])),64);
            tracep->chgQData(oldp+201,(((0x3dU == (IData)(vlSelf->top__DOT__idu_step__DOT___inst_now_T_194))
                                         ? vlSelf->top__DOT__exu_step__DOT__Regfile
                                                    ...
                                                    (0x1fU 
                                                     & (IData)(
                                                               (vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata 
                                                                >> 0x14U)))])
                                                    : 0ULL)))))),32);
            tracep->chgCData(oldp+210,(((0x3023U == 
                                         (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata)))
                                         ? 0xfU : (
                                                   (0x1023U 
                                                    == 
                                                            ...
                                                            (0x1fU 
                                                             & (IData)(
                                                                       (vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata 
                                                                        >> 0x14U)))])
                                                            : 0ULL))))))),64);
            tracep->chgCData(oldp+341,(((0x3023U == 
                                         (0x707fU & (IData)(vlSelf->top__DOT__ifu_step__DOT__axi__DOT__Mem_modle_Rdata)))
                                         ? 0xfU : (
                                                   (0x1023U 
                                                    == 
