...
void Vtop___024root___settle__TOP__1(Vtop___024root* vlSelf) {
    ...
    vlSelf->io_inst = vlSelf->top__DOT__ifu_step__DOT__inst;
    vlSelf->top__DOT__idu_step_io_ctrl_sign_Wmask = 
        ((0x3023U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst))
          ? 0xffU : ((0x1023U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst))
                      ? 3U : ((0x23U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst))
                               ? 1U : ((0x2023U == 
    ...
    vlSelf->top__DOT__idu_step_io_ctrl_sign_src1_is_pc 
        = ((0x6fU == (0x7fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
           | ((0x17U == (0x7fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
              | ((0x1063U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                 | ((0x63U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                    | ((0x5063U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                       | ((0x4063U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                          | ((0x6063U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                             | (0x7063U == (0x707fU 
                                            & vlSelf->top__DOT__ifu_step__DOT__inst)))))))));
    ...
    vlSelf->top__DOT__idu_step_io_ctrl_sign_Readmem_en 
        = ((0x3003U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
           | ((0x2003U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
              | ((0x6003U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                 | ((0x1003U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                    | ((0x5003U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                       | ((3U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                          | (0x4003U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst))))))));
    ...
    if ((0x13U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst))) {
        ...
        vlSelf->top__DOT__idu_step__DOT___inst_now_T_194 
            = ((0x100073U == vlSelf->top__DOT__ifu_step__DOT__inst)
                ? 2U : ((0x17U == (0x7fU & vlSelf->top__DOT__ifu_step__DOT__inst))
                         ? 3U : ((0x37U == (0x7fU & vlSelf->top__DOT__ifu_step__DOT__inst))
                                  ? 4U : ((0x6fU == 
                                           (0x7fU & vlSelf->top__DOT__ifu_step__DOT__inst))
                                           ? 5U : (IData)(top__DOT__idu_step__DOT___inst_now_T_189)))));
        vlSelf->top__DOT__idu_step__DOT___inst_type_T_188 
            = ((0x17U == (0x7fU & vlSelf->top__DOT__ifu_step__DOT__inst))
                ? 0x42U : ((0x37U == (0x7fU & vlSelf->top__DOT__ifu_step__DOT__inst))
    ...
    vlSelf->top__DOT__exu_step__DOT__CSR_Reg_MPORT_6_data 
        = ((((0x1073U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
             | ((0x2073U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                | (0x3073U == (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)))) 
            & (IData)(vlSelf->top__DOT__arbiter_io_ifu_axi_out_rvalid))
    ...
    vlSelf->top__DOT__exu_step__DOT__Regfile_MPORT_data 
        = (((((0x100073U != vlSelf->top__DOT__ifu_step__DOT__inst) 
              & ((0x3023U != (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                 & ((0x1023U != (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                    & ((0x23U != (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                       & ((0x2023U != (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                          & ((0x1063U != (0x707fU & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                             & ((0x63U != (0x707fU 
                                           & vlSelf->top__DOT__ifu_step__DOT__inst)) 
                                & ((0x5063U != (0x707fU 
                                      ...
                                      & ((0x6063U != 
                                         ...
                                         & ((0x7063U 
                                            ...
                                            & ((0x73U 
                                               ...
                                               & (0x30200073U 
                                                  != vlSelf->top__DOT__ifu_step__DOT__inst))))))))))))) 
             & (0U != (0x1fU & (vlSelf->top__DOT__ifu_step__DOT__inst 
...
void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__ifu_step__DOT__inst = VL_RAND_RESET_I(32);
