...
void Vtop___024root__traceFullSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+1710,((0x3fU & (IData)(vlSelf->top__DOT__IFU__DOT__pc_next))),6);
        tracep->fullCData(oldp+1711,((0xfU & (IData)(
                                                     (vlSelf->top__DOT__IFU__DOT__pc_next 
                                                      >> 6U)))),4);
        tracep->fullIData(oldp+1712,((0x3fffffU & (IData)(
                                                          (vlSelf->top__DOT__IFU__DOT__pc_next 
                                                           >> 0xaU)))),22);
        tracep->fullSData(oldp+1713,((0x1f8U & ((IData)(vlSelf->top__DOT__IFU__DOT__pc_next) 
                                                << 3U))),9);
