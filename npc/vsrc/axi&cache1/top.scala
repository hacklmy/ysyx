...
class top extends Module{
    ...
    ifu_step.io.axi_in <> i_cache.io.to_ifu
    i_cache.io.from_ifu <> ifu_step.io.axi_out
    //printf("cache arvalid:%d\n",cache.io.to_axi.arvalid)
    ...
    lsu_step.io.axi_in <> d_cache.io.to_lsu
    d_cache.io.from_lsu <> lsu_step.io.axi_out
    d_cache.io.pc_now := pc_now
