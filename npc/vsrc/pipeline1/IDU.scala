...
class IDU extends Module{
    ...
    conflict := ((!src1_is_pc||inst_type===B_TYPE.U) && (((rs1===io.es_rf_dst)&&(rs1=/=0.U)&&io.es_rf_we&&io.es_valid)||((rs1===io.ms_rf_dst)&&(rs1=/=0.U)&&io.ms_rf_we&&io.ms_valid)||((rs1===io.ws_rf_dst)&&(rs1=/=0.U)&&io.ws_rf_we&&io.ws_valid)))||((!src2_is_imm||inst_type===S_TYPE.U||inst_type===B_TYPE.U) && (((rs2===io.es_rf_dst)&&(rs2=/=0.U)&&io.es_rf_we&&io.es_valid)||((rs2===io.ms_rf_dst)&&(rs2=/=0.U)&&io.ms_rf_we&&io.ms_valid)||((rs2===io.ws_rf_dst)&&(rs2=/=0.U)&&io.ws_rf_we&&io.ws_valid)))
